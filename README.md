...
private routes and authentication tokens
- [ ] Describe how web servers work.
the user makes a request using a URL, web finds the server using the URL and gets the information from that server.
